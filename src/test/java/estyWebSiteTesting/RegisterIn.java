...
public class RegisterIn {
...

	{
		...
		Thread.sleep(WaitTime);
		String blankEmail = "";
		login.registerIn(blankEmail, Firstname, validPassword);
...

	{
		...
		login.registerIn(validEmail, blankFirstname, validPassword);
		Thread.sleep(WaitTime);
...

	{
		...
		login.registerIn(validEmail, Firstname, blankPassword);
		Thread.sleep(WaitTime);
	...
	public void TC_RegisterIn_005() throws InterruptedException {
		...
		login.registerIn(invalidEmail, Firstname, validPassword);
		Thread.sleep(WaitTime);
	...
	public void TC_RegisterIn_006() throws InterruptedException {
		...
		login.registerIn(validEmail, invalidName, validPassword);
		Thread.sleep(WaitTime);
