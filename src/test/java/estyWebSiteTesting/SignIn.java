...
public class SignIn {
	...
	@Test(priority = 1, description = "User can't sign in on website without entering email and password")
	...
	@Test(priority = 2, description = "User can't sign in on website without entering email")
	...
	@Test(priority = 3, description = "User can't sign in on website without entering password")
