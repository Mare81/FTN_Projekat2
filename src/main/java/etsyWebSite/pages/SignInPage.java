...
public class SignInPage {
	...
	public void registerIn(String email, String firstName, String password) {

		setEmail(email);
		setFirstName(firstName);
		setPassword(password);
		getRegisterInButton().click();
	...
	public WebElement getinvalidFirstNameMessage() {
		...
		return Utils.waitForElementPresence(driver,
				By.xpath("//div[text()='Your first name contains invalid characters.']"), WaitTime);

	}

	public WebElement getinvalidEmailAddressMessage() {

		return Utils.waitForElementPresence(driver, By.xpath("//div[text()='Please enter a valid email address.']"),
				WaitTime);
